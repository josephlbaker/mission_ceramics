    ...
    return (
      <div className="home-container">
        <div id="columns">
          ...
          <img src="https://images.unsplash.com/photo-1481401908818-600b7a676c0d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1051&q=80" alt="hero" className="hero-image" />
          <img src="https://images.unsplash.com/photo-1468531390554-9f62f9767a87?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=633&q=80" alt="hero" className="hero-image" />
          <img src="https://images.unsplash.com/photo-1481401908818-600b7a676c0d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1051&q=80" alt="hero" className="hero-image" />
          <img src="https://images.unsplash.com/photo-1468531390554-9f62f9767a87?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=633&q=80" alt="hero" className="hero-image" />
        </div>
